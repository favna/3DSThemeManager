...
std::map<std::string, std::wstring> FRENCH = {
	...
	{"dump_prompt_warn",    L"Ne soumettez pas des thèmes officiels à ThemePlaza SVP !"},
	{"playing",             L"Lecture..."},
	{"no_themes_1",         L"Aucun thème n'a été trouvé !"},
	{"no_themes_2",         L"Allez sur ThemePlaza, téléchargez des thèmes, et transférez"},
	...
	{"qr_explain_3",        L"Allez sur ThemePlaza, sélectionez un thème, et cliquez sur"},
