...
std::map<std::string, std::wstring> GERMAN = {
	...
	{"w_o_bgm",             L"w/o BGM"},
	{"fullscreen_prev",     L"Vollbild Vorschau"},
	...
	{"delete_prompt_1",     L"Bist du sicher das du"},
	...
	{"no_themes_2",         L"Gehe zu 3dsthem.es und lade ein paar Themes herunter,"},
	{"no_themes_3",         L"ziehe diese dann in den /Themes Ordner auf deiner SD-Karte"},
	...
	{"yes",                 L"Ja"},
	{"no",                  L"Nein"},
	{"stop_bgm",            L"Drücke (Y) um zu stoppen."},
	// THEME.CPP
	{"no_desc",             L"[Beschreibung nicht verfugbar]"},
	{"unknown",             L"Unbekannt"},
	...
	{"err_update_titledb", L"Solltest du immer noch Probleme haben, aktualisiere FBI -> TitleDB."},
	...
	{"err_try_default",    L"Versuche erst eines der normalen Themes im HOME-Menü auszuwählen, und probiere es nocheinmal"},
	{"err_no_dsp",         L"Dsp Dump nicht gefunden! Du brauchst ein Dump deiner DSP-Firm um Audio abzuspielen."}
};
